    ...
    <div class="min-h-screen">
        ...
        <div class="relative overflow-x-auto bg-neutral-primary-soft shadow-xs rounded-base border border-default">
            <div class="flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 p-4">
                ...
                <!-- Heading / Search helper (empty for logic, kept layout) -->
                <div>
                    <h2 class="text-lg font-semibold text-heading">Daftar Kategori</h2>
                </div>
                            ...
                            <div
                                ...
                                <form action="{{ route('admin.category.store') }}" method="POST">
                                    ...
                                    <div class="py-4 md:py-6 flex flex-col gap-4">
                                        <div>
                                            <label for="name"
                                                class="block mb-2.5 text-sm font-medium text-heading">Nama Kategori</label>
                                            <input type="text" name="name" id="name"
                                                class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                                                placeholder="Berita Terkini" required="">
                                        </div>
                                    </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-body">
                <thead class="text-sm text-body bg-neutral-secondary-medium border-b border-t border-default-medium">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 font-medium">Jumlah Artikel</th>
                        ...
                        <tr class="bg-neutral-primary-soft border-b border-default hover:bg-neutral-secondary-medium">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <!-- Tombol Edit -->
                                    <button type="button" data-modal-target="editModal-{{ $category->id }}"
                                    ...
                                    <!-- Tombol Delete -->
                                    <button type="button" data-modal-target="deleteModal-{{ $category->id }}"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div
                                            ...
                                            <div class="flex items-center justify-between border-b border-default pb-4 md:pb-5">
                                                ...
                                                <button type="button"
                                                    class="text-body bg-transparent hover:bg-neutral-tertiary hover:text-heading rounded-base text-sm w-9 h-9 ms-auto inline-flex justify-center items-center"
                                                    data-modal-hide="editModal-{{ $category->id }}">
                                                    <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                        width="24" height="24" fill="none" viewBox="0 0 24 24">
                                            ...
                                            <form action="{{ route('admin.category.update', $category) }}" method="POST">
                                                ...
                                                <div class="py-4 md:py-6 flex flex-col gap-4">
                                                    <div>
                                                        <label for="name_edit_{{ $category->id }}"
                                                            class="block mb-2.5 text-sm font-medium text-heading">Nama Kategori</label>
                                                        <input type="text" name="name" id="name_edit_{{ $category->id }}"
                                                            value="{{ $category->name }}"
                                                            class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                                                ...
                                                <div class="flex items-center space-x-4 border-t border-default pt-4 md:pt-6">
                                                    ...
                                                    <button data-modal-hide="editModal-{{ $category->id }}" type="button"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <button data-modal-hide="deleteModal-{{ $category->id }}" type="button"
